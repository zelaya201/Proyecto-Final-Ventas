...
public class VistaFactura extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/purchase_orderB_22px.png"))); // NOI18N
        jLabel3.setText("Facturas / lista de Facturas");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/package_search_25px.png"))); // NOI18N
        ...
        tablaFactura.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No. Factura", "Cliente", "Fecha", "Vendedor", "Iva ", "Total"
            }
        ) {
        ...
        if (tablaFactura.getColumnModel().getColumnCount() > 0) {
            ...
            tablaFactura.getColumnModel().getColumn(1).setPreferredWidth(0);
            tablaFactura.getColumnModel().getColumn(2).setResizable(false);
            tablaFactura.getColumnModel().getColumn(2).setPreferredWidth(0);
            tablaFactura.getColumnModel().getColumn(3).setResizable(false);
            tablaFactura.getColumnModel().getColumn(3).setPreferredWidth(0);
            tablaFactura.getColumnModel().getColumn(4).setResizable(false);
            tablaFactura.getColumnModel().getColumn(4).setPreferredWidth(0);
