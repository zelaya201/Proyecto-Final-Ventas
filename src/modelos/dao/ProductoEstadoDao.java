...
public class ProductoEstadoDao {
    ...
    public void update(ProductoEstado obj) {
        String sql = "update producto_estado set precio_compra_producto =?, precio_venta_producto =?, stock_producto =?, estado_producto =?, ganancia_producto =? where id_producto_estado=" + obj.getIdProductoEstado();
