...
public class PropietarioDao {
    ...
    public void update(Propietario obj) {
        String sql = "update propietario set id_propietario =?, dui_propietario =?, nit_propietario =?, tel_propietario =?, nom_propietario =?, ape_propietario =? where id_propietario=" + obj.getIdPersona();
