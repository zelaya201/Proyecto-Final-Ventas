...
public class ClienteDao {
    ...
    public void update(Cliente obj) {
        String sql = "update cliente set dui_cliente =?, nom_cliente =?, ape_cliente =?, dir_cliente =?, tel_cliente =?, email_cliente =? where idCliente=" + obj.getIdPersona();
    ...
    private ArrayList<Cliente> select(String sql){
        ...
        try {
            ...
            while(rs.next()) {
                obj = new Cliente();
                obj.setIdPersona(rs.getInt("idCliente"));
