...
public class SucursalDao {
    ...
    public boolean insert(Sucursal obj){
        String sql = "insert into sucursal(sucursal_dir,sucursal_tel,sucursal_nom,sucursal_estado,id_propietario1)VALUES(?,?,?,?,?)";
        return alterarRegistro(sql, obj);
    }
    
    public void update(Sucursal obj) {
        String sql = "update sucursal set sucursal_dir =?, sucursal_tel =?, sucursal_nom =?, sucursal_estado =?, id_propietario1 =? where id_sucursal=" + obj.getIdSucursal();
    ...
    private ArrayList<Sucursal> select(String sql){
        ...
        try {
            ...
            while(rs.next()) {
                ...
                obj.setEstado(rs.getInt("sucursal_estado"));
    ...
    private boolean alterarRegistro(String sql, Sucursal obj){
        try {
            ...
            ps.setInt(5, obj.getPropietario().getIdPersona());
